...
const OtherBusinesses = ({ currentPath }: OtherBusinessesProps) => {
  const allBusinesses = [
    {
      image:
  ...
  const otherBusinesses = allBusinesses.filter(
    (business) => business.path !== currentPath
  );
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Discover more ventures from the VKD Group portfolio.
          </p>
        </div>
