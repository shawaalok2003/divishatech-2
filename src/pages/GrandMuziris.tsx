        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-foreground mb-2">Deluxe Room</h3>
                <div className="text-2xl font-bold text-primary mb-3">₹4,999/night</div>
                <p className="text-muted-foreground mb-4">
                  Comfortable rooms with modern amenities and traditional Kerala decor elements.
                </p>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow border-2 border-primary">
              <Badge className="absolute top-4 right-4 bg-primary text-primary-foreground z-10">Popular</Badge>
              <img
              ...
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-foreground mb-2">Executive Suite</h3>
                <div className="text-2xl font-bold text-primary mb-3">₹8,999/night</div>
                <p className="text-muted-foreground mb-4">
                  Spacious suites with separate living area and premium furnishings.
                </p>
                <ul className="space-y-2 text-muted-foreground mb-6">
                  <li>• Premium King Bed</li>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-foreground mb-2">Presidential Suite</h3>
                <div className="text-2xl font-bold text-primary mb-3">₹15,999/night</div>
                <p className="text-muted-foreground mb-4">
                  Ultimate luxury with panoramic views and personalized butler service.
                </p>
                <ul className="space-y-2 text-muted-foreground mb-6">
